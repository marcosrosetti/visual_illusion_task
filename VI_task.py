...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\DevoPsycho_ThinkPad\\OneDrive\\Illusion study\\Visual_Ilusion\\Pilot.py',
...
hello_trainingClock = core.Clock()
...
Contrast_illusion_INTROClock = core.Clock()
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
hello_trainingClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "hello_training"-------
while continueRoutine:
    # get current time
    t = hello_trainingClock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=hello_trainingClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
thisExp.addData('hellomouse.started', hellomouse.tStart)
thisExp.addData('hellomouse.stopped', hellomouse.tStop)
thisExp.nextEntry()
thisExp.addData('hellotraining.started', hellotraining.tStartRefresh)
thisExp.addData('hellotraining.stopped', hellotraining.tStopRefresh)
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
longerline_1Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "longerline_1"-------
while continueRoutine:
    # get current time
    t = longerline_1Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=longerline_1Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
longerline_2Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "longerline_2"-------
while continueRoutine:
    # get current time
    t = longerline_2Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=longerline_2Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
longerline_3Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "longerline_3"-------
while continueRoutine:
    # get current time
    t = longerline_3Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=longerline_3Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
clickcircle1Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "clickcircle1"-------
while continueRoutine:
    # get current time
    t = clickcircle1Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=clickcircle1Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
clickcircle2Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "clickcircle2"-------
while continueRoutine:
    # get current time
    t = clickcircle2Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=clickcircle2Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
clickcircle3Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "clickcircle3"-------
while continueRoutine:
    # get current time
    t = clickcircle3Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=clickcircle3Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
clickcircle4Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "clickcircle4"-------
while continueRoutine:
    # get current time
    t = clickcircle4Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=clickcircle4Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
clickcircle5Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "clickcircle5"-------
while continueRoutine:
    # get current time
    t = clickcircle5Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=clickcircle5Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
clickcircle6Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "clickcircle6"-------
while continueRoutine:
    # get current time
    t = clickcircle6Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=clickcircle6Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
clickcircle7Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "clickcircle7"-------
while continueRoutine:
    # get current time
    t = clickcircle7Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=clickcircle7Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
clickcircle8Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "clickcircle8"-------
while continueRoutine:
    # get current time
    t = clickcircle8Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=clickcircle8Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
clickcircle9Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "clickcircle9"-------
while continueRoutine:
    # get current time
    t = clickcircle9Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=clickcircle9Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
clickcircle10Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "clickcircle10"-------
while continueRoutine:
    # get current time
    t = clickcircle10Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=clickcircle10Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
for thisTrial in trials:
    ...
    for thisA in A:
        ...
        t = 0
        _timeToFirstFrame = win.getFutureFlipTime(clock="now")
        ML_INTROClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
        frameN = -1
        ...
        while continueRoutine:
            ...
            tThisFlip = win.getFutureFlipTime(clock=ML_INTROClock)
            tThisFlipGlobal = win.getFutureFlipTime(clock=None)
            frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
            # update/draw components on each frame
        ...
        for thisML_rep in ML_rep:
            ...
            t = 0
            _timeToFirstFrame = win.getFutureFlipTime(clock="now")
            TEST_MLClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
            frameN = -1
            ...
            while continueRoutine and routineTimer.getTime() > 0:
                ...
                tThisFlip = win.getFutureFlipTime(clock=TEST_MLClock)
                tThisFlipGlobal = win.getFutureFlipTime(clock=None)
                frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
                # update/draw components on each frame
                ...
                if image_ML.status == STARTED:
                    ...
                    if tThisFlipGlobal > image_ML.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(image_ML, 'tStopRefresh')  # time at next scr refresh
                ...
                if LEFT_ML.status == STARTED:
                    ...
                    if tThisFlipGlobal > LEFT_ML.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(LEFT_ML, 'tStopRefresh')  # time at next scr refresh
                ...
                if RIGHT_ML.status == STARTED:
                    ...
                    if tThisFlipGlobal > RIGHT_ML.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(RIGHT_ML, 'tStopRefresh')  # time at next scr refresh
                ...
                if mouse_ML.status == STARTED:
                    ...
                    if tThisFlipGlobal > mouse_ML.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(mouse_ML, 'tStopRefresh')  # time at next scr refresh
                ...
                if ML_tracker.status == STARTED:
                    ...
                    if tThisFlipGlobal > ML_tracker.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(ML_tracker, 'tStopRefresh')  # time at next scr refresh
                ...
                if ROI_left_ML.status == STARTED:
                    ...
                    if tThisFlipGlobal > ROI_left_ML.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(ROI_left_ML, 'tStopRefresh')  # time at next scr refresh
                        ROI_left_ML.setAutoDraw(False)
                ...
                if ROI_right_ML.status == STARTED:
                    ...
                    if tThisFlipGlobal > ROI_right_ML.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(ROI_right_ML, 'tStopRefresh')  # time at next scr refresh
                        ROI_right_ML.setAutoDraw(False)
            ...
            t = 0
            _timeToFirstFrame = win.getFutureFlipTime(clock="now")
            pressspaceClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
            frameN = -1
            ...
            while continueRoutine:
                ...
                tThisFlip = win.getFutureFlipTime(clock=pressspaceClock)
                tThisFlipGlobal = win.getFutureFlipTime(clock=None)
                frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
                # update/draw components on each frame
            ...
            ML_rep.addData('Next_mouse.started', Next_mouse.tStart)
            ML_rep.addData('Next_mouse.stopped', Next_mouse.tStop)
    ...
    for thisB in B:
        ...
        t = 0
        _timeToFirstFrame = win.getFutureFlipTime(clock="now")
        Contrast_illusion_INTROClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
        frameN = -1
        ...
        while continueRoutine:
            ...
            tThisFlip = win.getFutureFlipTime(clock=Contrast_illusion_INTROClock)
            tThisFlipGlobal = win.getFutureFlipTime(clock=None)
            frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
            # update/draw components on each frame
        ...
        for thisContrast_rep in contrast_rep:
            ...
            t = 0
            _timeToFirstFrame = win.getFutureFlipTime(clock="now")
            TEST_contrastClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
            frameN = -1
            ...
            while continueRoutine and routineTimer.getTime() > 0:
                ...
                tThisFlip = win.getFutureFlipTime(clock=TEST_contrastClock)
                tThisFlipGlobal = win.getFutureFlipTime(clock=None)
                frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
                # update/draw components on each frame
                ...
                if image_cont.status == STARTED:
                    ...
                    if tThisFlipGlobal > image_cont.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(image_cont, 'tStopRefresh')  # time at next scr refresh
                ...
                if LEFT_cont.status == STARTED:
                    ...
                    if tThisFlipGlobal > LEFT_cont.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(LEFT_cont, 'tStopRefresh')  # time at next scr refresh
                ...
                if RIGHT_cont.status == STARTED:
                    ...
                    if tThisFlipGlobal > RIGHT_cont.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(RIGHT_cont, 'tStopRefresh')  # time at next scr refresh
                ...
                if mouse_cont.status == STARTED:
                    ...
                    if tThisFlipGlobal > mouse_cont.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(mouse_cont, 'tStopRefresh')  # time at next scr refresh
                ...
                if contrast_tracker.status == STARTED:
                    ...
                    if tThisFlipGlobal > contrast_tracker.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(contrast_tracker, 'tStopRefresh')  # time at next scr refresh
                        contrast_tracker.status = FINISHED
                
                # *ROI_LEFT_cont* updates
                if ROI_LEFT_cont.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    ...
                    ROI_LEFT_cont.setAutoDraw(True)
                if ROI_LEFT_cont.status == STARTED:
                    ...
                    if tThisFlipGlobal > ROI_LEFT_cont.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(ROI_LEFT_cont, 'tStopRefresh')  # time at next scr refresh
                        ROI_LEFT_cont.setAutoDraw(False)
                ...
                if ROI_RIGHT_cont.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    ...
                    ROI_RIGHT_cont.setAutoDraw(True)
                if ROI_RIGHT_cont.status == STARTED:
                    ...
                    if tThisFlipGlobal > ROI_RIGHT_cont.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(ROI_RIGHT_cont, 'tStopRefresh')  # time at next scr refresh
                        ROI_RIGHT_cont.setAutoDraw(False)
            ...
            contrast_rep.addData('mouse_cont.started', mouse_cont.tStart)
            contrast_rep.addData('mouse_cont.stopped', mouse_cont.tStop)
            ...
            contrast_rep.addData('Next_mouse.started', Next_mouse.tStart)
            contrast_rep.addData('Next_mouse.stopped', Next_mouse.tStop)
            # the Routine "pressspace" was not non-slip safe, so reset the non-slip timer
            routineTimer.reset()
            thisExp.nextEntry()
    ...
    for thisC in C:
        ...
        t = 0
        _timeToFirstFrame = win.getFutureFlipTime(clock="now")
        Ebbing_INTROClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
        frameN = -1
        ...
        while continueRoutine:
            ...
            tThisFlip = win.getFutureFlipTime(clock=Ebbing_INTROClock)
            tThisFlipGlobal = win.getFutureFlipTime(clock=None)
            frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
            # update/draw components on each frame
        ...
        for thisEbbing_rep in ebbing_rep:
            ...
            t = 0
            _timeToFirstFrame = win.getFutureFlipTime(clock="now")
            TEST_ebbingClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
            frameN = -1
            ...
            while continueRoutine and routineTimer.getTime() > 0:
                ...
                tThisFlip = win.getFutureFlipTime(clock=TEST_ebbingClock)
                tThisFlipGlobal = win.getFutureFlipTime(clock=None)
                frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
                # update/draw components on each frame
                ...
                if RIGHT_ebbing.status == STARTED:
                    ...
                    if tThisFlipGlobal > RIGHT_ebbing.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(RIGHT_ebbing, 'tStopRefresh')  # time at next scr refresh
                ...
                if LEFT_ebbing.status == STARTED:
                    ...
                    if tThisFlipGlobal > LEFT_ebbing.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(LEFT_ebbing, 'tStopRefresh')  # time at next scr refresh
                ...
                if image_ebbing.status == STARTED:
                    ...
                    if tThisFlipGlobal > image_ebbing.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(image_ebbing, 'tStopRefresh')  # time at next scr refresh
                ...
                if mouse_ebbing.status == STARTED:
                    ...
                    if tThisFlipGlobal > mouse_ebbing.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(mouse_ebbing, 'tStopRefresh')  # time at next scr refresh
                ...
                if ebbing_tracker.status == STARTED:
                    ...
                    if tThisFlipGlobal > ebbing_tracker.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(ebbing_tracker, 'tStopRefresh')  # time at next scr refresh
                        ebbing_tracker.status = FINISHED
                
                # *ROI_LEFT_ebbing* updates
                if ROI_LEFT_ebbing.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    ...
                    ROI_LEFT_ebbing.setAutoDraw(True)
                if ROI_LEFT_ebbing.status == STARTED:
                    ...
                    if tThisFlipGlobal > ROI_LEFT_ebbing.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(ROI_LEFT_ebbing, 'tStopRefresh')  # time at next scr refresh
                        ROI_LEFT_ebbing.setAutoDraw(False)
                ...
                if ROI_RIGHT_ebbingroi.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    ...
                    ROI_RIGHT_ebbingroi.setAutoDraw(True)
                if ROI_RIGHT_ebbingroi.status == STARTED:
                    ...
                    if tThisFlipGlobal > ROI_RIGHT_ebbingroi.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(ROI_RIGHT_ebbingroi, 'tStopRefresh')  # time at next scr refresh
                        ROI_RIGHT_ebbingroi.setAutoDraw(False)
            ...
            ebbing_rep.addData('mouse_ebbing.started', mouse_ebbing.tStart)
            ebbing_rep.addData('mouse_ebbing.stopped', mouse_ebbing.tStop)
            ...
            ebbing_rep.addData('Next_mouse.started', Next_mouse.tStart)
            ebbing_rep.addData('Next_mouse.stopped', Next_mouse.tStop)
            # the Routine "pressspace" was not non-slip safe, so reset the non-slip timer
            routineTimer.reset()
            thisExp.nextEntry()
    ...
    for thisD in D:
        ...
        t = 0
        _timeToFirstFrame = win.getFutureFlipTime(clock="now")
        Kanizsa_INTROClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
        frameN = -1
        ...
        while continueRoutine:
            ...
            tThisFlip = win.getFutureFlipTime(clock=Kanizsa_INTROClock)
            tThisFlipGlobal = win.getFutureFlipTime(clock=None)
            frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
            # update/draw components on each frame
        ...
        t = 0
        _timeToFirstFrame = win.getFutureFlipTime(clock="now")
        trainingKZSClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
        frameN = -1
        ...
        while continueRoutine:
            ...
            tThisFlip = win.getFutureFlipTime(clock=trainingKZSClock)
            tThisFlipGlobal = win.getFutureFlipTime(clock=None)
            frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
            # update/draw components on each frame
        ...
        for thisComponent in trainingKZSComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        D.addData('whitesquare.started', whitesquare.tStartRefresh)
        D.addData('whitesquare.stopped', whitesquare.tStopRefresh)
        ...
        t = 0
        _timeToFirstFrame = win.getFutureFlipTime(clock="now")
        trainingKZS_2Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
        frameN = -1
        ...
        while continueRoutine:
            ...
            tThisFlip = win.getFutureFlipTime(clock=trainingKZS_2Clock)
            tThisFlipGlobal = win.getFutureFlipTime(clock=None)
            frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
            # update/draw components on each frame
        ...
        D.addData('mouse_3.started', mouse_3.tStart)
        D.addData('mouse_3.stopped', mouse_3.tStop)
        ...
        for thisKN_rep in KN_rep:
            ...
            t = 0
            _timeToFirstFrame = win.getFutureFlipTime(clock="now")
            TEST_knzsClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
            frameN = -1
            ...
            while continueRoutine and routineTimer.getTime() > 0:
                ...
                tThisFlip = win.getFutureFlipTime(clock=TEST_knzsClock)
                tThisFlipGlobal = win.getFutureFlipTime(clock=None)
                frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
                # update/draw components on each frame
                ...
                if image_KN.status == STARTED:
                    ...
                    if tThisFlipGlobal > image_KN.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(image_KN, 'tStopRefresh')  # time at next scr refresh
                ...
                if LEFT_KN.status == STARTED:
                    ...
                    if tThisFlipGlobal > LEFT_KN.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(LEFT_KN, 'tStopRefresh')  # time at next scr refresh
                ...
                if RIGHT_KN.status == STARTED:
                    ...
                    if tThisFlipGlobal > RIGHT_KN.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(RIGHT_KN, 'tStopRefresh')  # time at next scr refresh
                ...
                if mouse_KN.status == STARTED:
                    ...
                    if tThisFlipGlobal > mouse_KN.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(mouse_KN, 'tStopRefresh')  # time at next scr refresh
                ...
                if Kanizsa_tracker.status == STARTED:
                    ...
                    if tThisFlipGlobal > Kanizsa_tracker.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(Kanizsa_tracker, 'tStopRefresh')  # time at next scr refresh
                ...
                if ROI_LEFT_KN.status == STARTED:
                    ...
                    if tThisFlipGlobal > ROI_LEFT_KN.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(ROI_LEFT_KN, 'tStopRefresh')  # time at next scr refresh
                        ROI_LEFT_KN.setAutoDraw(False)
                ...
                if ROI_RIGHT_KN.status == STARTED:
                    ...
                    if tThisFlipGlobal > ROI_RIGHT_KN.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(ROI_RIGHT_KN, 'tStopRefresh')  # time at next scr refresh
                        ROI_RIGHT_KN.setAutoDraw(False)
            ...
            KN_rep.addData('mouse_KN.started', mouse_KN.tStart)
            KN_rep.addData('mouse_KN.stopped', mouse_KN.tStop)
            ...
            KN_rep.addData('Next_mouse.started', Next_mouse.tStart)
            KN_rep.addData('Next_mouse.stopped', Next_mouse.tStop)
            # the Routine "pressspace" was not non-slip safe, so reset the non-slip timer
            routineTimer.reset()
            thisExp.nextEntry()
    ...
    for thisE in E:
        ...
        t = 0
        _timeToFirstFrame = win.getFutureFlipTime(clock="now")
        MS_INTROClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
        frameN = -1
        ...
        while continueRoutine:
            ...
            tThisFlip = win.getFutureFlipTime(clock=MS_INTROClock)
            tThisFlipGlobal = win.getFutureFlipTime(clock=None)
            frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
            # update/draw components on each frame
        ...
        for thisMS_rep in MS_rep:
            ...
            t = 0
            _timeToFirstFrame = win.getFutureFlipTime(clock="now")
            TEST_MSClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
            frameN = -1
            ...
            while continueRoutine and routineTimer.getTime() > 0:
                ...
                tThisFlip = win.getFutureFlipTime(clock=TEST_MSClock)
                tThisFlipGlobal = win.getFutureFlipTime(clock=None)
                frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
                # update/draw components on each frame
                ...
                if image_MS.status == STARTED:
                    ...
                    if tThisFlipGlobal > image_MS.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(image_MS, 'tStopRefresh')  # time at next scr refresh
                ...
                if LEFT_MS.status == STARTED:
                    ...
                    if tThisFlipGlobal > LEFT_MS.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(LEFT_MS, 'tStopRefresh')  # time at next scr refresh
                ...
                if RIGHT_MS.status == STARTED:
                    ...
                    if tThisFlipGlobal > RIGHT_MS.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(RIGHT_MS, 'tStopRefresh')  # time at next scr refresh
                ...
                if mouse_MS.status == STARTED:
                    ...
                    if tThisFlipGlobal > mouse_MS.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(mouse_MS, 'tStopRefresh')  # time at next scr refresh
                ...
                if MS_tracker.status == STARTED:
                    ...
                    if tThisFlipGlobal > MS_tracker.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(MS_tracker, 'tStopRefresh')  # time at next scr refresh
                ...
                if ROI_LEFT_MS.status == STARTED:
                    ...
                    if tThisFlipGlobal > ROI_LEFT_MS.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(ROI_LEFT_MS, 'tStopRefresh')  # time at next scr refresh
                        ROI_LEFT_MS.setAutoDraw(False)
                ...
                if ROI_RIGHT_MS.status == STARTED:
                    ...
                    if tThisFlipGlobal > ROI_RIGHT_MS.tStartRefresh + 15-frameTolerance:
                        ...
                        win.timeOnFlip(ROI_RIGHT_MS, 'tStopRefresh')  # time at next scr refresh
                        ROI_RIGHT_MS.setAutoDraw(False)
            ...
            MS_rep.addData('mouse_MS.started', mouse_MS.tStart)
            MS_rep.addData('mouse_MS.stopped', mouse_MS.tStop)
            ...
            MS_rep.addData('Next_mouse.started', Next_mouse.tStart)
            MS_rep.addData('Next_mouse.stopped', Next_mouse.tStop)
            # the Routine "pressspace" was not non-slip safe, so reset the non-slip timer
            routineTimer.reset()
            thisExp.nextEntry()
