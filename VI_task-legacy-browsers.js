...
function ML_INTRORoutineBegin(snapshot) {
  return async function () {
    ...
    ML_INTROComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TEST_MLRoutineBegin(snapshot) {
  return async function () {
    ...
    TEST_MLComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function pressspaceRoutineBegin(snapshot) {
  return async function () {
    ...
    pressspaceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Contrast_illusion_INTRORoutineBegin(snapshot) {
  return async function () {
    ...
    Contrast_illusion_INTROComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TEST_contrastRoutineBegin(snapshot) {
  return async function () {
    ...
    TEST_contrastComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Ebbing_INTRORoutineBegin(snapshot) {
  return async function () {
    ...
    Ebbing_INTROComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TEST_ebbingRoutineBegin(snapshot) {
  return async function () {
    ...
    TEST_ebbingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Kanizsa_INTRORoutineBegin(snapshot) {
  return async function () {
    ...
    Kanizsa_INTROComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trainingKZSRoutineBegin(snapshot) {
  return async function () {
    ...
    trainingKZSComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trainingKZS_2RoutineBegin(snapshot) {
  return async function () {
    ...
    trainingKZS_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TEST_knzsRoutineBegin(snapshot) {
  return async function () {
    ...
    TEST_knzsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function MS_INTRORoutineBegin(snapshot) {
  return async function () {
    ...
    MS_INTROComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TEST_MSRoutineBegin(snapshot) {
  return async function () {
    ...
    TEST_MSComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
